          ...
          >
            {chapters.length === 0 ? (
              ...
              chapters.map((chapter, index) => (
                <div
                  key={index}
                  className="group p-5 border border-gray-200 rounded-xl hover:border-gray-300 hover:shadow-sm transition-all bg-white"
                >
                  <div className="flex items-start gap-3 mb-3">
                    <div className="flex items-center justify-center w-7 h-7 rounded-full bg-violet-50 text-violet-600 text-xs font-semibold flex-shrink-0 mt-1">
                      {index + 1}
                    </div>
                    <div className="flex-1 flex items-center">
                      <input
                        ...
                        className="w-full bg-transparent border-none focus:outline-none focus:ring-0 text-gray-900 text-base font-semibold placeholder-gray-400"
                      />
                    </div>
                    <button
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full text-sm text-gray-600 bg-transparent  rounded-lg p-2 focus:outline-none focus:ring-1 focus:ring-violet-400 resize-none placeholder-gray-400"
                  />
                </div>
              ))
            )}
