...
const generateOutline=async (req,res)=>{
    try{
            ...
            [
                {
                    ...
                    "description":"A comprehensive overview introducing the main concept. Sets the foundation for understanding the subject matter."
                },
                {
        ...
        if(startIndex===-1 || endIndex===-1){
            console.error("Could not find JSON array n AI response",text);
...
const generateChapterContent=async (req,res)=>{
    try{
        ...
        const prompt=`You are an expert writer specilizing in ${style} content.Write a complete chapter for a book with the following specifications:
            ...
            3. Include relevent examples, explanations, or anecdotes as appropriate for the style
            4. Ensure the content flows logically from introduction to conclusion
            5. Make the content engaging and valuable to readers
            ${chapterDescription} ? '6. Cover all the points mentioned in the chapter description':''}
