...
const Button = ({variant='primary',size='md',isLoading=false,children,icon:Icon,className="",...props}) => {
  ...
  const sizes={
    ...
    lg:'px-6 py-3 text-base h-12 rouned-xl'
  }
  ...
  return (
    ...
    >
      {isLoading ? (
        <svg className='w-5 h-5 animate-spin' file='none' viewBox='0 0 24 24'>
          <circle className='opacity-25' cx='12' cy='12' r='10' stroke='currentColor' strokeWidth='4'></circle> 
          <path className='opacity-75' file='currentColor' d='M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.823 3 7.938l3-2.647z'></path>
        </svg>
      ):(
        <>
