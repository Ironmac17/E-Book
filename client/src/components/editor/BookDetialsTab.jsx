...
const BookDetialsTab = ({book,onBookChange,onCoverUpload,isUploading,fileInputRef}) => {
  ...
  return (
    <div className='p-8 max-w-4xl mx-auto'>
      ...
      <div className='bg-white border border-slate-200 rounded-xl p-6 shadow-sm mt-8'>
        <div className='text-lg font-semibold text-slate-900 mb-4'>Cover Image</div>
