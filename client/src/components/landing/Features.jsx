            ...
            return (
              ...
              >
                ...
                <div className="relative space-y-4">
                  <div
                    className={`w-14 h-12 bg-gradient-to-br ${feature.gradient} rounded-xl flex items-center justify-center shadow-lg shadow-${feature.gradient}/20 group-hover:scale-110 transition-transform duration-300`}
                  >
