...
const updateBookCover = async (req, res) => {
    try {
        ...
        // req.file.buffer now holds the image data in memory
        // Here’s where you'd upload to a cloud service, e.g. Cloudinary:
        /*
        ...
        */
        ...
        // For now, just store a placeholder (you can replace with actual upload result)
        book.coverImage = `data:${req.file.mimetype};base64,${req.file.buffer.toString("base64")}`;
